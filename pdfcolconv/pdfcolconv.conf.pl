# pdfcolconv.conf.pl
#
# configuration file for pdfcolconv.pl


# never delete this curly brace, file must have valid Perl syntax (check with "perl -c pdfcolconv.conf.pl")
{
...
# just keep empty to use default '/usr/local/pdfColorConvert_CLI/pdfColorConvert'
# pdfcolconv => '/path/to/your/installation/pdfColorConvert',
# with remote execution:
# pdfcolconv => 'ssh pdfserver.domain.org \'/usr/local/pdfColorConvert_CLI/pdfColorConvert',
...
# if pdfColorConvert run results in errors
...
# after finishing "pdfcolconv.pl" a postprocessing script might be called
...
# relative to HELIOSDIR/var/settings/pdfColorConvert
# or Profiles subdir of pdfColorConvert executable
...
# path may be absolute, otherwise relative to HELIOSDIR/var/settings/pdfColorConvert
# or Profiles subdir of pdfColorConvert executable
extlookup => {
...
Starte pdfColorConvert Lauf ueber die Datei
...
Der pdfColorConvert Lauf fuer Datei
...
resulttext => '--- pdfColorConvert Ergebnis ---
__DATE__
